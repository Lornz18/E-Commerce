...
export class ProductService {
    private productSubject = new BehaviorSubject<any[]>(this.getProducts());
    public product$: Observable<any[]> = this.productSubject.asObservable().pipe(
        ...
        return this.product$.pipe(
            map(products =>
                !category || category.toLowerCase() === 'all'
                    ? products // Return all products if category is "all" or empty
    ...
    getProductById(id: string): any {
        ...
        ).subscribe(result => product = result);
        return product;
    }
};